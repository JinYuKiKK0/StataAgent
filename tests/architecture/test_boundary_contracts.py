...
def test_domain_models_reexport_split_contracts() -> None:
    from stata_agent.domain.models import (
        QueryPlan,
    ...
    from stata_agent.domains.spec.types import RequirementParseResult as SplitRequirementParseResult
    ...
    assert RequirementParseResult is SplitRequirementParseResult
